...
for y_label,task,dimension,model,hyp_opt,feature_selection in itertools.product(y_labels,tasks[project_name],dimensions,models,hyp_opt_list,feature_selection_list):
