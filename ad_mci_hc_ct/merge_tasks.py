...
for comb in itertools.combinations(tasks,2):
    ...
    filename1 = f'combinada__ad_mci_hc__{task1}__features.csv'
    filename2 = f'combinada__ad_mci_hc__{task2}__features.csv'

    filename_save = f'combinada__ad_mci_hc__{task1}_{task2}__features.csv'
...
for comb in itertools.combinations(tasks,3):
    ...
    filename1 = f'combinada__ad_mci_hc__{task1}__features.csv'
    filename2 = f'combinada__ad_mci_hc__{task2}__features.csv'
    filename3 = f'combinada__ad_mci_hc__{task3}__features.csv'

    filename_save = f'combinada__ad_mci_hc__{task1}_{task2}_{task3}__features.csv'
